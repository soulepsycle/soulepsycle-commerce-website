            ...
            <div className="bg-white rounded-lg shadow-md overflow-x-auto">
              <table className="w-full">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {[
                    { id: '1234', customer: 'John Doe', date: '2023-05-20', total: '$123.45', status: 'Completed' },
                    { id: '1235', customer: 'Jane Smith', date: '2023-05-19', total: '$234.56', status: 'Processing' },
                    { id: '1236', customer: 'Bob Johnson', date: '2023-05-18', total: '$345.67', status: 'Shipped' },
                  ].map((order) => (
                    <tr key={order.id}>
